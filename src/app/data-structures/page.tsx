...
// Data
import { dataStructuresHubData as data } from "@/data/data-structures/hub-data";

export const metadata: Metadata = {
  title: "Data Structures Ecosystem | prashanta.dev",
      ...
      <main className="pt-header">
        <Container>
              ...
              {data.topicCategories.map((category) => (
                <div key={category.id} className="scroll-mt-32" id={category.id}>
                  ...
                  {category.topics.length > 0 && (
                    <div className="mb-8">
                      <FeaturedTopic topic={category.topics[0]} href={`/data-structures/${category.topics[0].slug}`} />
                    </div>
                  )}
          ...
          <Section className="py-20 text-center">
            <h3 className="text-2xl font-bold text-foreground mb-6">Ready to put these structures to use?</h3>
